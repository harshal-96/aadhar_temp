...
def process_single_entry(row, output_dir, photo_files):
    ...
    random_number=row['aadhar_number']
    random_number=str(random_number)

    random_number = re.sub(r"(\d{4})(\d{4})(\d{4})", r"\1 \2 \3", random_number)
    ...
    # for enrolment number values

    #Text: 7i47 5H/ Enrolment No:: 0000/00620/16566   Bounding Box: [[321, 1230], [1219, 1230], [1219, 1282], [321, 1282]]
